    ...
    return (
        <div className="note-item">
            ...
            <div className="note-item__action">
                {
                    note.archived === false ?
                    <button className="note-item__archive-button" onClick={onArchiveClick}>Arsip</button> :
                    <button className="note-item__archive-button" onClick={onArchiveClick}>Kembalikan</button>
                }
